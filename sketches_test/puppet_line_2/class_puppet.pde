...
class R_Puppet2D extends R_Line2D {
	private ArrayList<R_Pair> pair_list = new ArrayList<R_Pair>();
  ...
  /////////////////////////////////
	...
	public ArrayList<R_Pair> get_puppets() {
		return pair_list;
	}
	...
	public R_Pair get_puppet(int index) {
		if(index >= 0 && index < pair_list.size()) {
